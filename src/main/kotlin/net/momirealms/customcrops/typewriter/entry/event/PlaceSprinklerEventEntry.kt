...
@Entry(
    "customcrops_place_sprinkler_event",
    "CustomCrops Place Sprinkler Event",
    Colors.PURPLE,
    "material-symbols:bigtop-updates"
)
class PlaceSprinklerEventEntry(
...
@EntryListener(PlaceSprinklerEventEntry::class)
fun onSprinklerPlaceEvent(event: SprinklerPlaceEvent, query: Query<PlaceSprinklerEventEntry>) {
